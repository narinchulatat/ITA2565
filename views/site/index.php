          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">2. มีแบบสรุปผลการดำเนินการจัดซื้อจัดจ้างในรอบเดือน (แบบ สขร. 1) ไตรมาสที่ 3 เดือนเมษายน 2567 - เดือนมิถุนายน 2567 ดังนี้</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไตรมาสที่ 3 รอบแรก ของปีงบประมาณ พ.ศ. 2567 (1 ตุลาคม 2566-31 มีนาคม 2567)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">- รอบแรก ของปีงบประมาณ พ.ศ. 2567 (1 ตุลาคม 2566-31 มีนาคม 2567)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
                      'dataProvider' => $indicators148,
                      'itemView' => '/group/_indicators148',
                      'layout' => '{items}',
                    ]);
                    ?>
                  </div>
