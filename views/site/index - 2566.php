  ...
  <div class="body-content">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#tab_4" data-toggle="tab">แบบประเมินไตรมาสที่ 4</a></li>
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">2. รายงานผลการกำกับติดตามการเผยแพร่ข้อมูลต่อสาธารณะผ่านเว็บไซต์ของหน่วยงานในปีที่ผ่านมา (ปีงบประมาณ พ.ศ. 2565)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไตรมาสที่ 2 รอบสอง ของปีงบประมาณ พ.ศ. 2566 (1 เมษายน 2565-30 กันยายน 2565)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">- รอบสอง ของปีงบประมาณ พ.ศ. 2566 (1 เมษายน 2565-30 กันยายน 2565)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไตรมาสที่ 3 หน่วยงานวาง link จำนวน 3 link (Link ละ 1 เดือน)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">2. มีแบบสรุปผลการดำเนินการจัดซื้อจัดจ้างในรอบเดือน (แบบ สขร. 1) ไตรมาสที่ 3 เดือนเมษายน 2566 - เดือนมิถุนายน 2566 ดังนี้</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไตรมาสที่ 4</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">1. รายงานผลการดำเนินงานตามแผนปฏิบัติการป้องกัน ปราบปรามการทุจริต และประพฤติมิชอบของหน่วยงาน ประจำปีงบประมาณ พ.ศ. 2566 (รอบ 12 เดือน)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">2. รายงานผลการดำเนินงานตามแผนปฏิบัติการส่งเสริมคุณธรรมของชมรมจริยธรรมของหน่วยงาน ประจำปีงบประมาณ พ.ศ. 2566 (รอบ 12 เดือน)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  ...
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
                      'dataProvider' => $indicators107,
                      'itemView' => '/group/_indicators107',
                      'layout' => '{items}',
                    ]);
                    ?>
                  </div>
          ...
          <div class="box-body">
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไตรมาสที่ 4 หน่วยงานวาง link จำนวน 3 link (Link ละ 1 เดือน)</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
                      'dataProvider' => $indicators109,
                      'itemView' => '/group/_indicators109',
                      'layout' => '{items}',
                    ]);
                    ?>
                  </div>
              ...
              <div class="col-md-12">
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">2. มีแบบสรุปผลการดำเนินการจัดซื้อจัดจ้างในรอบเดือน (แบบ สขร. 1) ไตรมาสที่ 4 เดือนกรกฎาคม 2566 - เดือนกันยายน 2566 ดังนี้</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
                      'dataProvider' => $indicators110,
                      'itemView' => '/group/_indicators110',
                      'layout' => '{items}',
                    ]);
                    ?>
                  </div>
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title">ไม่มีข้อมูลที่ต้องบันทึก</h3>
                  </div>
                  <div class="box-body">
              ...
              <div class="col-md-12">
                ...
                <div class="panel box box-success">
                  <div class="box-header with-border">
                    <h3 class="box-title"> ไตรมาส 4</h3>
                  </div>
                  <div class="box-body">
                    <?php
                    echo ListView::widget([
                      'dataProvider' => $indicators108,
                      'itemView' => '/group/_indicators108',
                      'layout' => '{items}',
                    ]);
                    ?>
                  </div>
