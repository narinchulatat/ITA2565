                  ...
                  <div class="box-body">
                    ...
                    <div class="box-group">
                      <div class="panel box box-success">
                        <div class="box-header with-border">
                          <h4 class="box-title">
                            MOIT5 | 2. มีแบบสรุปผลการดำเนินการจัดซื้อจัดจ้างในรอบเดือน (แบบ สขร. 1) ไตรมาสที่ 4 เดือนกรกฎาคม 2565 - เดือนกันยายน 2565 ดังนี้
                          </h4>
                        </div>
                        <div class="panel-collapse collapse in">
                          <div class="box-body">
